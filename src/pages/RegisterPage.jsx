      ...
      <div className="register-form-container">
        <FormField className="register-form" onSubmit={handleSubmit}>
          ...
          <p style={{ textAlign: "center", fontWeight: 500 }}>
            already registered? click <Link to="/signIn">here</Link>
          </p>
        </FormField>
        <img
          className="signup-image"
          src="https://42f2671d685f51e10fc6-b9fcecea3e50b3b59bdc28dead054ebc.ssl.cf5.rackcdn.com/illustrations/sign_in_e6hj.svg"
          alt="signUp"
        />
      </div>
    </>
